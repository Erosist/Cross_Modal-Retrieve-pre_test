...
INPUT_JSONL = "/home/Masked_Reranker/dataset/MSCOCO/train2014/annotations/captions_val2014.json"        
...
def main(num_samples: int = 10):
    ...
    total_captions = len(annotations)
    print(f"总共有 {total_captions} 条 caption。")

    for item in tqdm(annotations[:num_samples], desc="Processing"):
