...
{
  "masked_sentences": [
    "A _ girl talking _ her cellphone while _ slowly down the street",
    "_ trendy girl _ _ her _ while gliding _ down the street",
    "A trendy _ _ on her _ _ _ slowly _",
    "A _ girl _ on _ cellphone while _ slowly down the street"
  ]
}
...
{
  "masked_sentences": [
    "_ young guys _ shaggy hair look _ their hands while hanging out in _ yard",
    "Two _ _ with shaggy _ look at their _ while hanging _ in the yard",
    "_ young _ with _ hair look at their hands _ hanging out in the yard",
    "Two young guys _ shaggy hair _ at their _ while hanging out in the yard"
  ]
}
...
def call_deepseek_mask(question: str, idx: str, retries: int = 3):
    ...
    messages = [
        {"role": "system", "content": SYSTEM_PROMPT_RANDOM_MASK_STRONG},
